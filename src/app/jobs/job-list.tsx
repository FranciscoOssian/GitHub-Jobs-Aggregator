...
// Separate component for the job grid to prevent re-rendering when toggling mobile filters
const JobGrid = memo(({ jobs, clearAll }: { jobs: Job[], clearAll: () => void }) => {
  return (
...
export function JobList({ jobs, allJobs, initialFilters }: JobListProps) {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-8 relative items-start">
      ...
      <aside className="hidden lg:block w-full lg:w-80 shrink-0 space-y-8 lg:sticky lg:top-[100px]">
        {FilterContent}
      </aside>
      ...
      <main className="flex-1 min-w-0">
        ...
        <JobGrid jobs={jobs} clearAll={clearAll} />
      </main>
    </div>
  );
}
